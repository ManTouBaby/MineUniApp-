...
var oJI=_v()
_(oHI,oJI)
if(_oz(z,13,e,s,gg)){oJI.wxVkey=1
var oVI=_n('view')
...
_(oHI,t7I)
var cRJ=_n('view')
_rz(z,cRJ,'class',48,e,s,gg)
var hSJ=_mz(z,'image',['class',49,'mode',1,'src',2],[],e,s,gg)
_(cRJ,hSJ)
_(oHI,cRJ)
var oTJ=_n('view')
...
var cUJ=_v()
_(oTJ,cUJ)
if(_oz(z,61,e,s,gg)){cUJ.wxVkey=1
var o4J=_n('view')
...
var o0J=_mz(z,'m-popup',['bind:__l',1,'bind:onPopupOutsideClick',1,'class',2,'data-event-opts',3,'isShow',4,'showType',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var lAK=_mz(z,'view',['bindtap',10,'class',1,'data-event-opts',2,'hoverClass',3],[],e,s,gg)
var aBK=_oz(z,14,e,s,gg)
_(lAK,aBK)
_(o0J,lAK)
var tCK=_mz(z,'view',['bindtap',15,'class',1,'data-event-opts',2,'hoverClass',3],[],e,s,gg)
...
var hKK=_mz(z,'paper-item',['bind:__l',25,'class',1,'item',2,'vueId',3],[],oHK,xGK,gg)
_(fIK,hKK)
return fIK
}
bEK.wxXCkey=4
_2z(z,22,oFK,e,s,gg,bEK,'item','index','index')
var oLK=_mz(z,'load-more',['bind:__l',29,'class',1,'loadMoreStatus',2,'vueId',3],[],e,s,gg)
_(c9J,oLK)
_(r,c9J)
return r
}
...
var lOK=_mz(z,'uni-nav-bar',['bind:__l',1,'bind:clickLeft',1,'bind:clickRight',2,'class',3,'data-event-opts',4,'fixed',5,'leftIcon',6,'rightText',7,'statusBar',8,'vueId',9,'vueSlots',10],[],e,s,gg)
var aPK=_mz(z,'view',['bindtap',12,'class',1,'data-event-opts',2],[],e,s,gg)
var tQK=_oz(z,15,e,s,gg)
_(aPK,tQK)
var eRK=_n('view')
...
var oVK=_mz(z,'textarea',['bindblur',21,'class',1,'data-event-opts',2,'placeholder',3],[],e,s,gg)
_(xUK,oVK)
_(oTK,xUK)
var fWK=_mz(z,'img-upload',['bind:__l',25,'bind:updateImgList',1,'class',2,'data-event-opts',3,'vueId',4],[],e,s,gg)
_(oTK,fWK)
_(bSK,oTK)
_(oNK,bSK)
var cXK=_mz(z,'m-popup',['bind:__l',30,'bind:onPopupOutsideClick',1,'class',2,'data-event-opts',3,'isShow',4,'showType',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var hYK=_n('view')
_rz(z,hYK,'class',39,e,s,gg)
var oZK=_n('view')
_rz(z,oZK,'class',40,e,s,gg)
var c1K=_mz(z,'image',['class',41,'mode',1,'src',2],[],e,s,gg)
_(oZK,c1K)
_(hYK,oZK)
var o2K=_n('view')
...
var o0K=_oz(z,52,e,s,gg)
_(x9K,o0K)
_(o2K,x9K)
_(hYK,o2K)
var fAL=_mz(z,'button',['bindtap',53,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var aHL=_mz(z,'image',['lazyLoad',-1,'class',2,'mode',1,'src',2],[],e,s,gg)
_(lGL,aHL)
_(oFL,lGL)
var tIL=_n('view')
...
var bKL=_mz(z,'image',['lazyLoad',-1,'class',7,'mode',1,'src',2],[],e,s,gg)
_(eJL,bKL)
var oLL=_n('view')
...
var aVL=_mz(z,'nav-bar',['bind:__l',20,'bind:navBarClick',1,'class',2,'data-event-opts',3,'isShowBottomBorder',4,'navBarDates',5,'navBartSelect',6,'vueId',7],[],e,s,gg)
_(lUL,aVL)
var tWL=_v()
_(lUL,tWL)
var eXL=function(oZL,bYL,x1L,gg){
var f3L=_mz(z,'view',['class',33,'hidden',1],[],oZL,bYL,gg)
var c4L=_v()
_(f3L,c4L)
var h5L=function(c7L,o6L,o8L,gg){
var a0L=_mz(z,'common-item',['bind:__l',40,'class',1,'id',2,'item',3,'vueId',4],[],c7L,o6L,gg)
_(o8L,a0L)
return o8L
}
c4L.wxXCkey=4
_2z(z,37,h5L,oZL,bYL,gg,c4L,'item1','index1','index1')
var tAM=_mz(z,'load-more',['bind:__l',45,'class',1,'loadMoreStatus',2,'vueId',3],[],oZL,bYL,gg)
_(f3L,tAM)
_(x1L,f3L)
return x1L
}
tWL.wxXCkey=4
_2z(z,30,eXL,e,s,gg,tWL,'item','index','index')
_(oFL,lUL)
_(r,oFL)
return r
}
...
var oDM=_mz(z,'nav-bar',['bind:__l',1,'bind:navBarClick',1,'class',2,'data-event-opts',3,'navBarDates',4,'navBartSelect',5,'vueId',6],[],e,s,gg)
_(bCM,oDM)
var xEM=_n('view')
_rz(z,xEM,'class',8,e,s,gg)
var oFM=_mz(z,'swiper',['bindchange',9,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var fGM=_v()
_(oFM,fGM)
var cHM=function(oJM,hIM,cKM,gg){
var lMM=_n('swiper-item')
_rz(z,lMM,'class',18,oJM,hIM,gg)
var aNM=_mz(z,'load-and-refresh-layout',['bind:__l',19,'bind:loadMore',1,'class',2,'data-event-opts',3,'loadMoreStatus',4,'vueId',5,'vueSlots',6],[],oJM,hIM,gg)
var tOM=_mz(z,'view',['class',26,'slot',1],[],oJM,hIM,gg)
var ePM=_v()
_(tOM,ePM)
var bQM=function(xSM,oRM,oTM,gg){
var cVM=_mz(z,'topic-item',['bind:__l',33,'class',1,'topicItem',2,'vueId',3],[],xSM,oRM,gg)
_(oTM,cVM)
return oTM
}
ePM.wxXCkey=4
_2z(z,30,bQM,oJM,hIM,gg,ePM,'item1','index1','index1')
_(aNM,tOM)
_(lMM,aNM)
_(cKM,lMM)
return cKM
...
fGM.wxXCkey=4
_2z(z,16,cHM,e,s,gg,fGM,'item','index','index')
_(xEM,oFM)
_(bCM,xEM)
_(r,bCM)
return r
...
var cYM=_mz(z,'nav-bar',['bind:__l',1,'bind:navBarClick',1,'class',2,'data-event-opts',3,'fixed',4,'isShowBottomBorder',5,'navBarDates',6,'navBartSelect',7,'vueId',8],[],e,s,gg)
_(oXM,cYM)
var oZM=_n('view')
_rz(z,oZM,'class',10,e,s,gg)
var l1M=_mz(z,'swiper',['bindchange',11,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var a2M=_v()
_(l1M,a2M)
var t3M=function(b5M,e4M,o6M,gg){
var o8M=_n('swiper-item')
_rz(z,o8M,'class',20,b5M,e4M,gg)
var f9M=_mz(z,'load-and-refresh-layout',['bind:__l',21,'bind:loadMore',1,'class',2,'data-event-opts',3,'loadMoreStatus',4,'vueId',5,'vueSlots',6],[],b5M,e4M,gg)
var c0M=_mz(z,'view',['class',28,'slot',1],[],b5M,e4M,gg)
var hAN=_v()
_(c0M,hAN)
var oBN=function(oDN,cCN,lEN,gg){
var tGN=_mz(z,'user-list-item',['bind:__l',35,'class',1,'item1',2,'vueId',3],[],oDN,cCN,gg)
_(lEN,tGN)
return lEN
}
hAN.wxXCkey=4
_2z(z,32,oBN,b5M,e4M,gg,hAN,'item1','index1','index1')
_(f9M,c0M)
_(o8M,f9M)
_(o6M,o8M)
return o6M
...
a2M.wxXCkey=4
_2z(z,18,t3M,e,s,gg,a2M,'item','index','index')
_(oZM,l1M)
_(oXM,oZM)
_(r,oXM)
return r
